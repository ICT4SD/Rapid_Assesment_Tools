...
def mySim(text1, text2, sigma=0.85, w=0.3, corpus='ic-brown-resnik.dat'):
    ...
    for w1, w2 in product(pos_p, pos_r):
        ...
        for t1, t2 in product(w1_set, w2_set):
            ...
            count += 1
            print('{:.4f}'.format(get_sim_score(t1, t2, info_content)), '\t\t', t1,'|', t2)
...
if __name__ == '__main__':
    ...
    test = 'Similarly, maternal mortality increased from 180 per 100,000 births in 1990 to 220 in 2000, before improving again to around 180 in recent years.'
